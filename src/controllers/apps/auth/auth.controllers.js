...
const getAllUsers = asyncHandler(async (req, res) => {
  ...
  const users = await User.find({ role: UserRolesEnum.USER }).select(
    "-password -refreshToken -emailVerificationToken -emailVerificationExpiry" // Exclude sensitive fields
  );
